...
OPENING_CATEGORY_SEEDS = [
    {"name_ja": "相居飛車", "sort_order": 10, "description": "双方が居飛車で戦う代表的な序盤分類です。", "source_url": "https://ja.wikibooks.org/wiki/将棋/将棋の戦法一覧", "license": "CC BY-SA"},
    ...
    {"name_ja": "奇襲・B級戦法", "sort_order": 40, "description": "意表を突く構想や力戦志向の戦法です。", "source_url": "https://ja.wikibooks.org/wiki/将棋/将棋の戦法一覧", "license": "CC BY-SA"},
    {"name_ja": "囲い・構想", "sort_order": 50, "description": "序盤構想や玉の囲いに関する項目です。", "source_url": "https://ja.wikipedia.org/wiki/将棋の戦法", "license": "CC BY-SA"},
]

OPENING_TYPE_SEEDS = [
    ("相居飛車", None, "矢倉", "やぐら", "Yagura", ["矢倉戦法"], "相居飛車を代表する堅陣志向の戦型です。", "Wikibooks 将棋の戦法一覧", "https://ja.wikibooks.org/wiki/将棋/将棋の戦法一覧", "CC BY-SA", 10),
    ...
    ("対抗型", None, "中飛車", "なかびしゃ", "Central Rook", [], "飛車を5筋に振って中央から戦う振り飛車です。", "Wikibooks 将棋の戦法一覧", "https://ja.wikibooks.org/wiki/将棋/将棋の戦法一覧", "CC BY-SA", 10),
    ...
    ("対抗型", None, "向かい飛車", "むかいびしゃ", "Opposing Rook", [], "相手飛車の向かい側に飛車を振る戦型です。", "Wikibooks 将棋の戦法一覧", "https://ja.wikibooks.org/wiki/将棋/将棋の戦法一覧", "CC BY-SA", 40),
    ...
    ("奇襲・B級戦法", None, "鬼殺し", "おにごろし", "Demon Killer", [], "桂跳ねを絡めて急戦を狙う奇襲戦法です。", "Wikibooks 将棋の戦法一覧", "https://ja.wikibooks.org/wiki/将棋/将棋の戦法一覧", "CC BY-SA", 20),
    ...
    ("奇襲・B級戦法", None, "右四間飛車", "みぎしけんびしゃ", "Right Fourth File Rook", [], "右辺に飛車を寄せて4筋突破を狙う急戦構想です。", "Wikibooks 将棋の戦法一覧", "https://ja.wikibooks.org/wiki/将棋/将棋の戦法一覧", "CC BY-SA", 50),
...
def seed_opening_catalog_if_empty(conn) -> None:
    row = conn.execute("SELECT COUNT(*) AS c FROM opening_categories").fetchone()
    if row["c"] == 0:
        conn.executemany(
            """
